...
/**
 * This class is used to build the WP Live Stats component via a shortcode.
 *
...
class Shortcode {
	...
	private function __construct() {
		...
		add_shortcode( 'wp-live-stats', array( $this, 'shortcode' ) );
	}
	...
	/**
	 * Build the WP-Live-Stats shortcode
	 *
	 * @since     1.0.0
	...
	public function shortcode( $atts ) {
		...
		$shortcode = '<div class="wp-live-stats-shortcode" data-object-id="' . $object_name . '"></div>';
		return $shortcode;
	}
}
